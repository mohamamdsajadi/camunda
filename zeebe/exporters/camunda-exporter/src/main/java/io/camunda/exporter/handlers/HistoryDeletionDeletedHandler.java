...
public class HistoryDeletionDeletedHandler
  ...
  public void updateEntity(
    ...
    final long resourceKey = value.getResourceKey();
    final long batchOperationKey = record.getBatchOperationReference();
    entity.setId(String.format(ID_PATTERN, batchOperationKey, resourceKey));
